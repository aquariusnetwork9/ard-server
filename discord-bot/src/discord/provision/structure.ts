...
export const CATEGORIES: CategorySpec[] = [
  ...
  },
  {
    ...
    channels: [
      { name: '🗨️・2b2t-general', topic: 'General 2b2t chat.', oldNames: ['2b2t-general'] },
      ...
      { name: '🆘・2b2t-help', topic: 'Ask for help with anything 2b2t-related.', oldNames: ['2b2t-help'] },
  ...
  },
  {
    ...
    channels: [
      { name: '🗨️・6b6t-general', topic: 'General 6b6t chat.', oldNames: ['6b6t-general'] },
      ...
      { name: '🆘・6b6t-help', topic: 'Ask for help with anything 6b6t-related.', oldNames: ['6b6t-help'] },
